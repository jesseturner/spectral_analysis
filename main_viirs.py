...
v_utils.plot_viirs_data(da_btd, "plots", save_name, plot_title, extent=[-73, -57, 33, 46], pin_coords=(36, -72))
...
# dnb_file_path = os.path.join("data/dnb", dnb_file)
...
# v_utils.plot_dnb_radiance(da, "plots", save_name, plot_title, extent=[-73, -57, 33, 46], pin_coords=(40, -67.75))


#--- Plot the VIIRS spectral response functions

# srf_file = "data/spectral_response_functions/NPP_VIIRS_NG_RSR_M12_FAKE.dat"
