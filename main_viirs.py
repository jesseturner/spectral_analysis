...
da_m12 = v_utils.open_viirs_file(file_path, "M12")
da_m12 = v_utils.replace_viirs_fill_values(da_m12)
print(da_m12)

da_m15 = v_utils.open_viirs_file(file_path, "M15")
da_m15 = v_utils.replace_viirs_fill_values(da_m15)
print(da_m15)
