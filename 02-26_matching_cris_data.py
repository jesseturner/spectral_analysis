...
def main():
    ...
    get_matching_cris_files(orbit_files_select)
    import sys
    sys.exit()
...
def get_matching_cris_files(orbit_files_select):
    for i in orbit_files_select:
        print(i)
    ...
    key = "CrIS-FS-SDR/2026/02/04/SCRIF_j01_d20260204_t0000029_e0000327_b42558_c20260204003929722000_oebc_ops.h5"
    ...
    s3.download_file(bucket, key, "data/cris/temp_cris_file.h5")
